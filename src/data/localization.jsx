const text = {
    ...
    "pt": {
        ...
        firstScreen: {
            ...
            aboutUs: "Sobre Nós",
            back: "Voltar",
            readyQuestion: "Estás preparado(a)?",
            btnReady: "Sim",
            btnNotReady: "Não"
        },
        mapScreen: {
        ...
        experiences: {
            ...
            "gremio-lit": {
                ...
                instructions: [
                    "Olha em volta e encontra a estátua da Justiça na casa de partida.",
                    "Arrasta a estátua pelo caminho azul até ao topo.",
                    "Para ganhares tens de obter ideais (lâmpadas) e emoções (corações).",
                    "Tem cuidado com as caveiras. Elas tiram-te emoções.",
                    "Se as caveiras te acertarem quando não tens emoções, perdes o jogo.",
                    [
                        "Boa sorte!",
                        "Vamos Começar",
                    ],
            ...
            "graffiti-1": {
                ...
                instructionsEasy: [
                    "Olha em volta e encontra a lata de tinta spray.",
                    "Toca uma vez na lata de tinta spray para a agarrares — não precisas de manter o dedo no ecrã.",
                    "Quando olhares em volta, ela vai apontar na direção do teu olhar.",
                    "Depois, quando vires uma esfera semi-transparente, toca e segura (com o mesmo dedo ou outro) para começares a pintar com tinta spray.",
                    "Enquanto pintas o graffiti, a barra de progresso em baixo vai-se preenchendo.",
                    "Quando tiveres pintado a maior parte do graffiti, podes clicar na barra de progresso para saber mais sobre a pessoa retratada no graffiti.",
                    "Diverte-te!",
                ],
