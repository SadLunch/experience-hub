...
const SpawnModelLiveSize = ({setIsAR, setEndSession}) => {
  ...
  useEffect(() => {
    ...
    loader.load("/models/room.glb", (gltf) => {
      ...
      model.position.set(0, -1.6, 0).applyMatrix4(cameraRef.current.matrixWorld); // Place model in front of camera
