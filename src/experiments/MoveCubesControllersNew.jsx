  ...
  const initAR = () => {
    try {
      ...
      if (!controller1Ref.current) {
        ...
        controller1.addEventListener('selectstart', (event) => { console.log("Select Start 1: ", event.data.targetRayMode); });
        controller1.addEventListener('selectend', (event) => { console.log("Select End 1: ", event.data.targetRayMode); });
      ...
      if (!controller2Ref.current) {
        ...
        controller2.addEventListener('selectstart', (event) => { console.log("Select Start 2: ", event.data.targetRayMode); });
        controller2.addEventListener('selectend', (event) => { console.log("Select End 2: ", event.data.targetRayMode); });
      ...
      if (controller1Ref.current) controller1Ref.current.add(line.clone());
      if (controller2Ref.current) controller2Ref.current.add(line.clone());
      ...
      const animate = () => {
        ...
        intersectObjects(controller1Ref.current);
        intersectObjects(controller2Ref.current);
